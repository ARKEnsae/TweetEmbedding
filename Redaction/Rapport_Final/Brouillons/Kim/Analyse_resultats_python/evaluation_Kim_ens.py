...
res_ens_dim20 = tableau_corr_hji(learning_rate = [0.01,0.02],
                       window = [3,4,5], dim = 20, index="seed",
                       distance = "cos", epoch=[10,100])[0]

res_ens_dim20_50 = tableau_corr_hji(learning_rate = [0.01,0.02],
                       window = [3,4,5], dim = [20,50], index="seed",
