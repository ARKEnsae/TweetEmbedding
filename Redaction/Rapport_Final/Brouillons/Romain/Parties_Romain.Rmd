...
En effet, le modèle doit capter grâce dans les vecteurs ces notions de proximité entre mots. 
...
C'est une génération de la notion de variance dans le cadre multivarié et c'est cette quantité que l'ACP cherche à représenter au mieux sur les axes factoriels.
