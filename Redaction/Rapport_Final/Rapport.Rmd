...
Dans la suite de ce projet nous noterons $n$ la taille du vocabulaire (i.e. : le nombre de mots différents) et $d$ la dimension retenue pour les *word-embeddings*.
