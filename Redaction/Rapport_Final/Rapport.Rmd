...
<!-- si on prend en compte les deux pour WOrd2Vec : on a alors 36.19% des mots du voc qui sont absents, soit 4.62% des mots. -->


<!-- A caser si utile dans l'argumentaire ici et si change les proportions : Nous avons donc testé notre modèle sur une nouvelle base de test de tweets annotés indépendante des autres bases^[$52,04 \%$ des mots du vocabulaire dec cette base sont absents de la base d'entraînement, soit $12.73\%$ des mots du corpus. Pour le modèle *Word2Vec*, en ajoutant les mots n'ayant pas de représentations vectorielles, on arrive à $52,76\%$ du vocabulaire soit $12,96\%$ des mots du corpus]. Cette expérimentation confirme le biais attendu puisque, avec cette nouvelle base, l'accuracy du modèle basé sur les *word-embedding* est supérieure à celle de l'approche de référence ($68,7 \%$ contre $55,9 \%$) 



BASE GIT :
BASELINE : 52.04% des mots du voc de la base test GIT ne sont pas dans la base train, soit 12,73% des mots
WORD2VEC : 29.00% des mots de la base test GIT ne sont pas dans WORD2VEC, soit 6.15% des mots, auxquels il faut ajouter comme pour l'autre modèle les mots
de la base test GIT qui ne sont pas dans la base train, donc on arrive à 52.76% des mots du voc, soit 12.96% des mots du corpus
(donc beaucoup de mot de la base test qui sont pas dans train sont pas non plus das WOrd2VEC) -->
