...
### *Word2Vec*, un modèle d’apprentissage « auto-supervisé »
...
L'objectif de cette partie est de décrire le fonctionnement de l'algorithme *Word2Vec*. Deux architectures du modèle existent (voir graphique \@ref(fig:cbowskipgram)) :
...
Dans la suite de ce projet nous noterons $n$ la taille du vocabulaire (i.e. : le nombre de mots différents). L'approche *Skip-gram* peut être vue comme un réseau de neurone avec trois couches. 
