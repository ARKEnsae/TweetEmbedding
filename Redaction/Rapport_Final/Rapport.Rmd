...
- L'approche *Continuous bags of words* dont l'objectif est d'estimer la probabilité d'observer un mot, appelé *focus*, sachant le contexte dans lequel il apparait (i.e. : les mots voisins).  
