...
Pour cela, nous calculons une représentation vectorielle de chaque tweet en faisnat la moyenne de celles de chaque mots présents dans le tweet. 
...
L'objectif de la désaisonnaliser est de décomposer une série $X_t$ en trois composantes inobservées :

- $TC_t$ la tendance-cycle
